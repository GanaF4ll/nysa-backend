...
async function main() {
  ...
  const events = [
    ...
    },
    {
      ...
      end_time: new Date('2024-06-15T23:00:00Z'),
      address: '5 Rue des Dames, Paris',
      latitude: 48.8566,
      longitude: 2.3522,
      max_participants: 4,
      visibility: Event_visibility.PUBLIC,
      entry_fee: 20,
      description: 'QLQ CHOSE',
      creator_id: createdUsers[0].id,
    },
    {
      title: 'Event passé 2',
      start_time: new Date('2024-04-15T18:00:00Z'),
      end_time: new Date('2024-04-15T23:00:00Z'),
      address: '5 Rue des Dames, Paris',
      latitude: 48.8566,
      longitude: 2.3522,
      max_participants: 4,
    ...
    },
    {
      ...
      end_time: new Date('2024-07-15T23:00:00Z'),
      address: '5 Rue des Dames, Paris',
      latitude: 48.8566,
      longitude: 2.3522,
      max_participants: 4,
